...
A responsive personal portfolio website by **MaKJ**, built as part of the MST Connect PH Full-Stack Web Development Bootcamp. The site introduces me as an aspiring full-stack web developer and showcases my current skills, projects, contact information, and professional links.

## Live Demo

> Add your GitHub Pages link here after deployment.

[View Portfolio](https://mackyjay.github.io/portfolio-web/)
...
### Home / Hero
Introduces **MaKJ** as an aspiring full-stack web developer and includes buttons for viewing projects and visiting GitHub.
